...
export const Header = ({
  ...
  showIcon,
    ...
    <header className="resume-header" style={{ fontFamily: font }}>
      <div>
        <img src={header.picture} alt={`${header.name}-picture`} style={{ borderRadius: '50%', width: 'auto', objectFit: 'cover', height: '70px' }} />
