...
describe("ToolsReducer", () => {
  ...
  describe("TOGGLE_SHOW_ITEM", () => {
    ...
    it("Should toggle the visibility of the certification resume elements", () => {
      let state = {
        showCertification: false
      };
      let action = toggleShowItem("showCertification");
      state = ToolsReducer(state, action);
      expect(state.showCertification).toEqual(true);
      state = ToolsReducer(state, action);
      expect(state.showCertification).toEqual(false);
    });
