...
context('Click Editor Button Go to Editor page and return to home page', () => {
  ...
  it('should toggle Editor Button', () => {
    ...
    cy.get('#root > div > aside > div > div:nth-child(2) > h1').contains('JSON Resume'); 
	cy.get('#root > div > div.ui.scale.down.right.very.wide.visible.sidebar > div.ui.massive.borderless.top.attached.menu > div:nth-child(1)').should('not.exist');
